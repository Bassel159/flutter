  ...
  Future<void> loadApplications() async {
    ...
    filteredList =
        filteredList.where((app) {
          ...
          if (selectedExpectedGraduation != null &&
              selectedExpectedGraduation!.isNotEmpty) {
            matches &= app['expectedgrad'] == selectedExpectedGraduation;
          }
          if (selectedPreferredIndustry != null &&
              selectedPreferredIndustry!.isNotEmpty) {
                    ...
                    child: Wrap(
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged:
                              (value) =>
                                  setModalState(() => selectedMajor = value),
                        ),
                        SizedBox(height: 10),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged:
                              (value) =>
                                  setModalState(() => selectedGPA = value),
                        ),
                        SizedBox(height: 10),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged:
                              (value) => setModalState(
                                () => selectedExpectedGraduation = value,
                              ),
                        ),
                        SizedBox(height: 10),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged:
                              (value) => setModalState(
                                () => selectedPreferredIndustry = value,
                              ),
                        ),
                        SizedBox(height: 20),
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            print(
                              "Expected Graduation: $selectedExpectedGraduation",
                            );
                            print(
                              "Preferred Industry: $selectedPreferredIndustry",
                            );
                            Navigator.of(
                              context,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (app['interviewDate'] != null)
                                  Text(
                                    "Interview Date: ${DateFormat('yyyy-MM-dd hh:mm a').format((app['interviewDate'] as Timestamp).toDate())}",
